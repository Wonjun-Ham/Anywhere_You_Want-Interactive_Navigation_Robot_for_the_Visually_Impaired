...
def plot_trajs_and_points_on_image( # 여기
    ax: plt.Axes,
    img: np.ndarray,
    dataset_name: str,
    list_trajs: list,
    list_points: list,
    traj_colors: list = [RED, GREEN, GREEN, GREEN, GREEN, GREEN, GREEN, GREEN, GREEN],
    point_colors: list = [RED, GREEN, GREEN, GREEN, GREEN, GREEN, GREEN, GREEN, GREEN],
):
    """
    ...
    if (
        ...
        for i, traj in enumerate(list_trajs): # naction[0] = RED traj color
